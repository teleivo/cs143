...
class ASTLexer implements java_cup.runtime.Scanner {
  ...
  private final int yy_state_dtrans[] = {0, 139};
        ...
        if (YY_NO_STATE == yy_last_accept_state) {
          ...
          switch (yy_last_accept_state) {
            ...
            case 3:
              {
                return new Symbol(
                    ASTConstants.INT_CONST, AbstractTable.inttable.addString(yytext()));
              }
            case -4:
              break;
            case 4:
              {
                return new Symbol(ASTConstants.ID, AbstractTable.idtable.addString(yytext()));
              }
            case -5:
              break;
            case 5:
            ...
            case 9:
              {
                return new Symbol(ASTConstants.LINENO, new Integer(yytext().substring(1)));
              }
            case -10:
              break;
            case 10:
            ...
            case 42:
              {
                yybegin(YYINITIAL);
                return new Symbol(
                    ASTConstants.STR_CONST, AbstractTable.stringtable.addString(buf.toString()));
              }
            case -43:
              break;
            case 43:
